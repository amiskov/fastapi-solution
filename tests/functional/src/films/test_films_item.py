...
@pytest.mark.asyncio
async def test_films_item_by_id_blank(
        setup: None,
    ...
    """
    Тест на вызов ручки /films/:id/ без параметров.
...
@pytest.mark.asyncio
async def test_films_item_by_id_cache_exists(
        setup: None,
        session: ClientSession,
        es_client: AsyncElasticsearch,
        make_get_request: Callable,
...
@pytest.mark.asyncio
async def test_films_item_by_id_cache_not_exists(
        setup: None,
        session: ClientSession,
        es_client: AsyncElasticsearch,
        make_get_request: Callable,
